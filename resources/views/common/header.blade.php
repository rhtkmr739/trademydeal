...
<header class="main-header">
    <!-- logo-->
        <a href="/" class="logo-custom-text-holder">
    ...
    <!-- header opt --> 
    <a href="dashboard-add-listing.html" class="add-list color-bg">Post Your Requirement<span><i class="fal fa-layer-plus"></i></span></a>
    <div class="cart-btn   show-header-modal" data-microtip-position="bottom" role="tooltip" aria-label="Your Wishlist"></div>
    ...
    <div class="nav-holder main-menu">
        <nav>
            <ul class="no-list-style">
                ...
                <li>
                    <a href="blog.html">Food Products & Beverage</a>
                </li>
                <li>
                    <a href="blog.html">Electronics & Electrical</a>
                </li>
                
                <li>
                    <a href="blog.html">Health & Beauty</a>
                </li>
                <li>
                    <a href="blog.html">View All Categories <i class="fas fa-chevron-right"></i></a>
                </li>
            </ul>
        </nav>
    </div>
