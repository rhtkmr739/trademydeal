            ...
            <div id="wrapper">
                ...
                <div class="content">
                    ...
                    <section class="parallax-section dashboard-header-sec gradient-bg" data-scrollax-parent="true">
                        <div class="container">
                            <div class="dashboard-breadcrumbs breadcrumbs"><a href="#">Home</a><span>Admin Dashboard</span></div>
                        ...
                        <div class="dashboard-header fl-wrap">
                            <div class="container">
                                <div class="dashboard-header_conatiner fl-wrap">
                                                ...
                                                <div class="swiper-wrapper">
                                                    ...
                                                    <div class="swiper-slide">
                                                        <div class="dashboard-header-stats-item">
                                                            ...
                                                            New Leads Counts	
                                                            <span>{{$getAdminDashboardData[0]->newLeadRequirementsCounts}}</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="swiper-slide">
                                                        <div class="dashboard-header-stats-item">
                                                            <i class="fal fa-map-marked"></i>
                                                            Verified Leads Counts	
                                                            <span>{{$getAdminDashboardData[0]->verifiedLeadsCounts}}</span>
                                                        </div>
                                                    </div>
                                                    <!--  dashboard-header-stats-item end -->
                                                    <!--  dashboard-header-stats-item -->
                                                    <div class="swiper-slide">
                                                        <div class="dashboard-header-stats-item">
                                                            ...
                                                            Total Sellers Count
                                                            <span>{{$getAdminDashboardData[0]->sellerCounts}}</span>	
                                                        </div>
                                                    </div>
                                                    <!--  dashboard-header-stats-item end -->
                                                    <!--  dashboard-header-stats-item -->
                                                    <div class="swiper-slide">
                                                        <div class="dashboard-header-stats-item">
                                                            ...
                                                            <span>{{$getAdminDashboardData[0]->productCounts}}</span>	
                                                        </div>
                                                    </div>
                                                    <!--  dashboard-header-stats-item end -->
                                                    <!--  dashboard-header-stats-item -->
                                    ...
                                    <div>
                                    <a href="/admin/create-new-lead" class="add_new-dashboard">Add Lead <i class="fal fa-layer-plus"></i></a>
                                &nbsp;
                                <a href="/admin/create-employee" class="add_new-dashboard">Add Employee <i class="fal fa-user"></i></a>
                                &nbsp;
                                    <!--  dashboard-header-stats-wrap end -->
                                                ...
                                                <div class="inline-facts">
                                                    ...
                                                    <div class="milestone-counter">
                                                        <div class="stats animaper">
                                                            <div class="num" data-content="0" data-num="{{$getAdminDashboardData[0]->newLeadRequirementsCounts}}">0</div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="inline-facts-wrap gradient-bg ">
                                                <div class="inline-facts">
                                                    ...
                                                    <div class="milestone-counter">
                                                        <div class="stats animaper">
                                                            <div class="num" data-content="0" data-num="{{$getAdminDashboardData[0]->sellerCounts}}">0%</div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="inline-facts-wrap gradient-bg ">
                                                <div class="inline-facts">
                                                    ...
                                                    <div class="milestone-counter">
                                                        <div class="stats animaper">
                                                            <div class="num" data-content="0" data-num="{{$getAdminDashboardData[0]->productCounts}}">0</div>
                                                        </div>
                                                    </div>
