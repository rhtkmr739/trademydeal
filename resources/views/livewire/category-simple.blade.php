                        ...
                        <div class="container big-container">
                            ...
                            <div class="listing-filters gallery-filters fl-wrap">
                                ...
                                @foreach($getCategories as $categories)
                                    <a href="#" class="gallery-filter category-gap" data-filter=".{{ $categories->category_sku }}">{{ $categories->category_name }} ({{ $categories->sub_category_count }})</a>
                                @endforeach
                            </div>
                                    ...
                                    <div class="listing-item">
                                        <article class="geodir-category-listing fl-wrap">
                                            <div class="geodir-category-img">
                                                ...
                                                <img src="theme/images/all/1.jpg" alt=""> 
                                                </a>
                                                ...
                                                <div class="geodir-category-footer fl-wrap">
                                                    ...
                                                    <div class="geodir-opt-list">
                                                        <ul class="no-list-style">
                                                            ...
                                                            <li>
                                                                <div class="dynamic-gal gdop-list-link" data-dynamicPath="[{'src': 'theme/images/all/1.jpg'},{'src': 'theme/images/all/1.jpg'}]"><i class="fal fa-search-plus"></i><span class="geodir-opt-tooltip">Gallery</span></div>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="price-level geodir-category_price">
